...
public interface JavaListener extends ParseTreeListener {
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#typeSpec}.
	 * @param ctx the parse tree
	 */
	void enterTypeSpec(JavaParser.TypeSpecContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#typeSpec}.
	 * @param ctx the parse tree
	 */
	void exitTypeSpec(JavaParser.TypeSpecContext ctx);
	/**
	...
	/**
	 * Enter a parse tree produced by {@link JavaParser#arrow}.
	 * @param ctx the parse tree
	 */
	void enterArrow(JavaParser.ArrowContext ctx);
	/**
	 * Exit a parse tree produced by {@link JavaParser#arrow}.
	 * @param ctx the parse tree
	 */
	void exitArrow(JavaParser.ArrowContext ctx);
	/**
